...
pub const SCRATCHPAD: Range = Range {
    start: 0x1F80_0000,
    end: 0x1F80_0400,
};
pub const MEMORY_CONTROL_1: Range = Range {
    start: 0x1F80_1000,
    end: 0x1F80_1024,
};
...
pub const DMA_REGISTERS: Range = Range {
    start: 0x1F80_1080,
    end: 0x1F80_1100,
};
pub const TIMERS: Range = Range {
    start: 0x1F80_1100,
    end: 0x1F80_112C,
};
pub const CDROM_REGISTERS: Range = Range {
    start: 0x1F80_1800,
    end: 0x1F80_1804,
};
pub const GPU_REGISTERS: Range = Range {
    start: 0x1F80_1810,
    end: 0x1F80_1818,
};
...
pub const EXP3: Range = Range {
    start: 0x1FA0_0000,
    end: 0x1FC0_0000,
};

// 512 KB of BIOS, mapped at 0x1FC0_0000
pub const BIOS: Range = Range {
    start: 0x1FC0_0000,
    end: 0x1FC8_0000,
};
