...
pub struct InterruptController {
    pub stat: u16, // I_STAT: pending interrupts
    pub mask: u16, // I_MASK: enabled interrupts
}
...
impl InterruptController {
    ...
    pub fn read_stat(&self) -> u32 { self.stat as u32 }
    pub fn read_mask(&self) -> u32 { self.mask as u32 }
    pub fn write_stat(&mut self, value: u16) { self.stat &= value; }
    pub fn write_mask(&mut self, value: u16) { self.mask = value; }
    pub fn raise_interrupt(&mut self, interrupt: Interrupt) { self.stat |= 1 << (interrupt as u16); }
    pub fn pending(&self) -> bool { return (self.stat & self.mask) != 0; }
}
